...
<header id="domu">
        ...
        <nav class="container">
            ...
            <ul class="topbuttons">
                ...
                <li><a href="index.php"><button class="btn" on>Domů</button></a></li>
                <li><a href="index.php#cenik"><button class="btn">Služby</button></a></li>
                <li><a href="index.php#omne"><button class="btn">O mně</button></a></li>
                <li><a href="index.php#registrace"><button class="btn">Registrace</button></a></li>
                <li><a href="index.php#kontakt"><button class="btn">Kontakt</button></a></li>
            </ul>
